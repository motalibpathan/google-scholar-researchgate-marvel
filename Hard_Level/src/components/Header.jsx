...
const Header = ({ setIsModalOpen }) => {
  ...
  return (
    <div className="w-full bg-[#2a2a2a] border-b">
      <div className="max-w-[1200px] w-full mx-auto lg:p-0 px-3 py-5">
        <div className="flex flex-wrap justify-between items-center ">
          <div className="border-l border-r border-gray-500 flex p-3 gap-2 items-center ">
            <svg
              width={20}
              fill="#fff"
          ...
          <div className="text-center text-[12px] uppercase text-white font-bold flex items-center gap-3 border-l border-r border-gray-500 p-3">
            <img
              className="w-5"
      ...
      <div className="flex justify-center items-center border-t border-b border-gray-600">
        <div className="flex lg:p-0 px-5 flex-wrap gap-6 text-white uppercase text-[12px] font-bold">
          {[
            "News",
            "Comics",
            "Characters",
            ...
            <a
              key={li}
              className="py-3 border-b-2 border-[#2a2a2a] hover:border-red-600"
              href="#"
            >
              {li}
            </a>
